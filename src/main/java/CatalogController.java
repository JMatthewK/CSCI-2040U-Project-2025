...
public class CatalogViewer {
    ...
    //Add item screen
    public void addItem() {
        JPanel addPanel = new JPanel(new GridLayout(11, 2)); // Increased row count for back button
        ...
        backButton.addActionListener(e -> startMainMenu());
        ...
        addPanel.add(uploadImageButton);
        addPanel.add(imagePathLabel);
        addPanel.add(addButton);
        addPanel.add(backButton); // Added Back Button
